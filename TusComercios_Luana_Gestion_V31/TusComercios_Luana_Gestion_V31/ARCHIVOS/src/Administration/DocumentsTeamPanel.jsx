...
export default function DocumentsTeamPanel({
  ...
  async function printDocument(document) {
    ...
    popup.document.write(`<!doctype html>
      ...
      <footer>Documento interno no válido como factura fiscal. Generado mediante TusComercios Gestión.</footer>
  ...
  function previewDraft() {
    ...
    popup.document.write(`<!doctype html><html><head><meta charset="utf-8"><title>Vista previa</title>
      ...
      <p class="box">Documento interno no válido como factura fiscal · Generado con TusComercios Gestión.</p></body></html>`);
    popup.document.close();
  }
