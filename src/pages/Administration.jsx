...
export default function Administration() {
  ...
  async function startAdministrationTrial() {
    if (!businessId) {
      setMessage("Primero seleccioná el negocio que va a usar Gestión.");
      return;
    }
    try {
      setCheckoutLoading(true);
    ...
    return (
      <div className="grid min-h-screen place-items-center bg-slate-100 p-5">
        <div className="max-w-lg rounded-[2rem] bg-white p-8 text-center shadow-xl">
          ...
          <h1 className="mt-4 text-3xl font-black">TusComercios Gestión</h1>
    ...
    return (
      <div className="grid min-h-screen place-items-center bg-slate-100 p-5">
        <div className="max-w-lg rounded-[2rem] bg-white p-8 text-center shadow-xl">
          ...
          <p className="mt-3 text-slate-600">
            Gestión se conecta con los negocios publicados en TusComercios.
          </p>
          <Link
        ...
        <div className="mx-auto flex max-w-[1600px] items-center justify-between gap-3 px-4 py-3">
          <div className="flex min-w-0 items-center gap-3">
            ...
            <div className="min-w-0">
              <p className="truncate text-lg font-black">TusComercios Gestión</p>
      ...
      <div className="mx-auto grid max-w-[1600px] lg:grid-cols-[250px_minmax(0,1fr)]">
        ...
        >
          ...
          <div className="mt-8 rounded-3xl bg-white/10 p-4">
            ...
            <p className="mt-2 text-2xl font-black">$24.999</p>
          ...
          {!hasAccess && (
            <section className="mt-5 rounded-[2rem] border-2 border-amber-300 bg-amber-50 p-6">
              <p className="font-black text-amber-950">
                {trialUsed
                  ? "La prueba gratuita de Gestión finalizó."
                  : "Probá Gestión gratis durante 10 días."}
              </p>
              ...
              <div className="mt-4 flex flex-col gap-3 sm:flex-row">
                ...
                <button type="button" disabled={checkoutLoading} onClick={subscribeAdministration} className="rounded-2xl bg-slate-950 px-6 py-4 font-black text-white disabled:opacity-50">
                  {checkoutLoading ? "Conectando con Mercado Pago..." : "Contratar por $24.999/mes"}
                </button>
              </div>
            </section>
          )}
